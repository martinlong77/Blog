...
$(function(){
	...
	$.formValidator.initConfig({formID:"AdminEditPwdForm",theme:'App',onSuccess:AdminPwdSave,submitAfterAjaxPrompt:'有数据正在异步验证，请稍等...',inIframe:true});
...
<table cellspacing="10">
	...
	<tr>
		...
		<td><div id="new_passwordTip"></td>
	</tr>
	<tr>
		<td>重复新密码：</td>
		<td><input id="new_pwdconfirm" type="password" style="width:180px;height:22px" /></td>
		<td><div id="new_pwdconfirmTip"></td>
	</tr>
	<tr>
		<td colspan="3"><a id="AdminPwdSubbtn" class="easyui-linkbutton">提交</a></td>
	</tr>
</table>
</form>
</div>