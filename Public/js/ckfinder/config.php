...
$config['Thumbnails'] = Array(
		'url' => $baseUrl . '_thumbs' .'/'. date('Y') .'/'. date('m') .'/'. date('d'),
		'directory' => $baseDir . '_thumbs' .'/'. date('Y') .'/'. date('m') .'/'. date('d'),
		'enabled' => true,
		'directAccess' => false,
		'maxWidth' => 100,
		'maxHeight' => 100,
...
$config['ResourceType'][] = Array(
		...
		'url' => $baseUrl . 'files' . date('Y') .'/'. date('m') .'/'. date('d'),
...
$config['ResourceType'][] = Array(
		'name' => 'Images',
		'url' => $baseUrl . date('Y') .'/'. date('m') .'/'. date('d'),
		'directory' => $baseDir . date('Y') .'/'. date('m') .'/'. date('d'),
		'maxSize' => '2M',
...
$config['ResourceType'][] = Array(
		'name' => 'Flash',
		'url' => $baseUrl . 'flash' . date('Y') .'/'. date('m') .'/'. date('d') ,
		'directory' => $baseDir . 'flash' . date('Y') .'/'. date('m') .'/'. date('d'),
		'maxSize' => '2M',
