...
class IndexAction extends Action {
    ...
    Public function registered() {
        ...
        $nickname = $User->user_nickname; //存入SESSION中的昵称变量
        //$User->user_avatar = '/Public/images/common/main/default.gif';
        ...
        if (!$id) {
          ...
          session('avatar', '/Public/images/common/main/default.gif');
          $blogUrl = U('Blog/proBlog?blog=1&id='.$_SESSION['id']);
          $this->ajaxReturn($blogUrl,'<span class="category">恭喜您！注册成功！<a href="'.$blogUrl.'">页面将在 <b id="wait_time">2</b>秒后跳转，如不想等待请点击此处。</a></span>',1);
        }
  }
